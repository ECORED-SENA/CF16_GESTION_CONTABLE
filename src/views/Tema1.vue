  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    .titulo-principal
      .titulo-principal__numero
        span 1
      h1 Costos
    p.mb-3 Es de recordar que los costos hacen énfasis al dinero que una empresa invierte para la producción de algún tipo de bien o servicio, es decir, son los recursos económicos que se utilizan para la producción, donde se incluyen los valores del producto y/o prestación del servicio, con el fin de determinar el precio de venta para ofrecer en el mercado.
    .row.justify-content-around.align-items-center.mb-5
      .col-lg-7.justify-content-md-center.align-self-center
        figure.mb-5
          img.img-450.mb-2(src="@/assets/tema1/img-1.svg")

    #t_1_1.titulo-segundo
      h2 1.1 Concepto de contabilidad de costos
    p En el ámbito empresarial este concepto es aplicable a los diferentes tipos de contabilidad, como pueden ser financiera, administrativa o de costos; en esta unidad se hace énfasis en la contabilidad de costos, teniendo en cuenta su importancia en las diferentes empresas. 
 
    p La contabilidad de costos hace referencia al proceso de recopilar información que permita calcular el valor de la producción de un bien o prestación de servicios para planear, controlar y tomar decisiones que permitan generar rentabilidad a la empresa.
    separador
    #t_1_2.titulo-segundo
      h2 1.2 Importancia y objetivos de la contabilidad de costos
    p Esta contabilidad es una variable muy importante dentro de una organización, teniendo en cuenta que:      
    ...
    .row.justify-content-around.align-items-center.p-5  
      ...
      .col-lg.justify-content-md-center.align-self-center.mb-5  
        .ul.lista-ul--color
          ...
          li 
            i.fas.fa-check
            p Contribuye a la toma de decisiones para mejorar, ver el crecimiento y la evolución de la organización en el tiempo.
          li 
            i.fas.fa-check
            p Controla el manejo de los recursos y la forma de optimizarlos.
          li 
            i.fas.fa-check
            p Permite a la alta gerencia poseer un mayor control sobre los recursos utilizados para el desarrollo de la actividad económica.

        p La contabilidad de costos persigue como objetivos principales:
        ol.lista-ol--cuadro
          li 
            .lista-ol--cuadro__vineta
              span a
            | Planificar y controlar las operaciones y los costos.
          li 
            .lista-ol--cuadro__vineta
              span b
          ...
          li 
            .lista-ol--cuadro__vineta
              span c
            | Servir de herramienta administrativa para la toma de decisiones.
          li 
            .lista-ol--cuadro__vineta
              span d
            | Facilitar el control, asignación y optimización de recursos.
          li 
            .lista-ol--cuadro__vineta
              span e
            | Es una herramienta para la elaboración de presupuestos (Emprendefx.com, s.f., p. 1).
          ...
          .row
            ...
            .col-lg-6
              .ul.lista-ul--color.texto-der
                li 
                  i.fas.fa-check
                  p Conocer el costo total de producción.
                li 
                  i.fas.fa-check
                  p Tomar decisiones sobre comprar o fabricar un producto.
                li 
                  i.fas.fa-check
                  p Valuar la producción del período.
                li 
                  i.fas.fa-check
                  p Establecer un precio de venta determinando el margen de utilidad por cada producto.



        div
          h3 Servir de herramienta administrativa para la toma de decisiones
          p Los costos dentro de una empresa pueden influir en la toma de decisiones. La contabilidad de costos dispone los instrumentos necesarios para determinar las políticas de producto o servicio más convenientes.
    ...
    .row.justify-content-around.align-items-center.px-5  
      ...
      .col-lg.justify-content-md-center.align-self-center.mx-5
        .row.fond1.mb-5
          spam 
            i.t-gr.text-bold ¿
    ...
    p.mb-5 Con el fin de avanzar satisfactoriamente en el proceso formativo, es importante apropiarse de los diferentes conceptos; por lo que, a continuación, se analiza la diferencia entre costo y gasto:
    h4.mb-5 Costo 
    ...
    .row.justify-content-around.align-items-center.mb-5
      .col-lg-10.justify-content-md-center.align-self-center
        .tarjeta.color-primario.mb-5.fond3.px-4.p-3
          .row.justify-content-around.align-items-center
    ...
    h3 Norma Internacional de Contabilidad (NIC) 2 Inventarios                    
    .row.justify-content-around.align-items-center
      .col-lg.justify-content-md-center.align-self-center
        ...
        p Otras normas han realizado modificaciones consiguientes de menor importancia a la NIC 2. Estas incluyen la NIIF 13 Medición del valor razonable (emitida en mayo de 2011), la NIIF 9 Instrumentos financieros (contabilidad de coberturas y modificaciones a las NIIF 9, NIIF 7 y NIC 39) (emitida en noviembre de 2013), NIIF 15 Ingresos de actividades ordinarias procedentes de contratos con clientes (emitida en mayo de 2014), NIIF 9 Instrumentos financieros (emitida en julio de 2014) y NIIF 16 Arrendamientos (emitida en enero de 2016) (NIC, s.f., pp. 4-16).
    ...
    .row.mb-5
      .col-md-6.col-lg.mb-5.mb-lg-0
        .tarjeta-avatar
          img(src='@/assets/tema1/img-13.svg' alt='AvatarTop')

          .tarjeta.fondo5
            .p-4
              p.text-center #[strong Materia prima y/o material directo]
              p Para ser considerado materiales directos debe ser de fácil identificación en cada unidad de producto.
      .col-md-6.col-lg.mb-5.mb-lg-0
        .tarjeta-avatar
          img(src='@/assets/tema1/img-14.svg' alt='AvatarTop')

          .tarjeta.fondo5
            .p-4
              p.text-center #[strong Sueldos y salarios y/o obra de mano]
              p Se refiere a los salarios de los trabajadores por la transformación de los materiales en productos acabados.      

      .col-md-6.col-lg.mb-5.mb-lg-0
        .tarjeta-avatar
          img(src='@/assets/tema1/img-15.svg' alt='AvatarTop')

          .tarjeta.fondo5
            .p-4
              p.text-center #[strong Gastos indirectos de producción]
    ...
    .ul.lista-ul--color.mx-5
      ...
      li 
        i.fas.fa-check
        p #[strong MOD:] salarios de los operarios como cortadores, armadores, pintores, cepilladores, etc.
      li 
        i.fas.fa-check
    ...
    .row.justify-content-around.align-items-center.px-5.mb-4  
      ...
      .col-lg.justify-content-md-center.align-self-center
        ...
        .ul.lista-ul--color
          li 
            i.fas.fa-check
            p #[strong Bajo pedido:] este se realiza por solicitud directa de un cliente.
          li 
            i.fas.fa-check
    ...
    .row.justify-content-around.align-items-center.px-5  
      ...
      .col-lg.justify-content-md-center.align-self-center    
        .ul.lista-ul--color
          li 
            i.fas.fa-check
            p #[strong Costo total ]= Costos fijos + costos variables
          li 
            i.fas.fa-check
            p #[strong Costo unitario ]= Costo total / número de unidades a producir

      .col-12.col-lg-auto.justify-content-md-center.mb-4  
        img(src="@/assets/tema1/img-18.svg", alt="alt")   

    h3 Punto de equilibrio
    p Es una herramienta estratégica para determinar la solvencia de un negocio y su rentabilidad, es el punto de partida para determinar dónde empieza una empresa a obtener utilidad sobre sus ventas.
    p La fórmula que se presenta es:
    .row.justify-content-around.align-items-center.mb-5
      .col-lg-7.justify-content-md-center.align-self-center
        figure.mb-5
          img.img-450.mb-2(src="@/assets/tema1/img-18-.svg")    

    h3 Proceso contable de los costos

    p De acuerdo con los costos de producción, es importante tener en cuenta la estructura y naturaleza de las cuentas para el reconocimiento y medición.
